...
일반적인 번역기와 달리, 원하는 **톤앤매너(Tone)**와 **원하는 개수(기본 3가지)**에 맞춰 추천 문장과 함께 각 문장의 세밀한 **뉘앙스 차이(설명)**를 한국어로 제공합니다.
...
2. **다양한 톤앤매너 지원 (Tones):**
   ...
   - _(※ 외부 JSON 설정을 연동하여 나만의 톤을 추가하거나 불필요한 기본 톤을 숨길 수도 있습니다.)_

3. **뉘앙스 설명 제공:**
   - 생성된 영작 제안 옵션마다 어떤 상황에 적합한지 한국어 설명이 함께 표시됩니다.
...
## 고급 설정 (톤 커스터마이징 및 제안 개수 설정) ⚙️

드롭다운 목록에서 항상 선택할 수 있는 **톤(Tone Style) 목록**을 입맛에 맞게 커스터마이징할 수 있습니다. 또한, 설정 화면에서 AI가 생성할 **영어 제안의 개수(기본 3개)**를 직접 선택할 수 있습니다.
